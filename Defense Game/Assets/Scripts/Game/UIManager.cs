...
public class UIManager : MonoBehaviour
{
    ...
    public void UpdateGameDisplay(int playerlife, int enemypassed)
    {
        _hud.UpdateUIText(playerlife, enemypassed);

    }

    public void UpdateEnemyDisplay(int enemykilled)
    {
        _hud.UpdateEnemyKilled(enemykilled);
